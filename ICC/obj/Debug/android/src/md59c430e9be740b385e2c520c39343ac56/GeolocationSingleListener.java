...
/** @hide */
	...
	static {
		__md_methods = 
			...
			"";
		mono.android.Runtime.register ("Geolocator.Plugin.GeolocationSingleListener, Geolocator.Plugin, Version=1.0.3.0, Culture=neutral, PublicKeyToken=null", GeolocationSingleListener.class, __md_methods);
	}
	...
	public GeolocationSingleListener ()
	{
		...
		if (getClass () == GeolocationSingleListener.class)
			mono.android.TypeManager.Activate ("Geolocator.Plugin.GeolocationSingleListener, Geolocator.Plugin, Version=1.0.3.0, Culture=neutral, PublicKeyToken=null", "", this, new java.lang.Object[] {  });
	}
