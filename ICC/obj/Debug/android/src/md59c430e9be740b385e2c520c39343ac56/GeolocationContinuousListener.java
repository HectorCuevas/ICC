package md59c430e9be740b385e2c520c39343ac56;
...
/** @hide */
	...
	static {
		__md_methods = 
			...
			"";
		mono.android.Runtime.register ("Geolocator.Plugin.GeolocationContinuousListener, Geolocator.Plugin, Version=1.0.3.0, Culture=neutral, PublicKeyToken=null", GeolocationContinuousListener.class, __md_methods);
	}
	...
	public GeolocationContinuousListener ()
	{
		...
		if (getClass () == GeolocationContinuousListener.class)
			mono.android.TypeManager.Activate ("Geolocator.Plugin.GeolocationContinuousListener, Geolocator.Plugin, Version=1.0.3.0, Culture=neutral, PublicKeyToken=null", "", this, new java.lang.Object[] {  });
	}
